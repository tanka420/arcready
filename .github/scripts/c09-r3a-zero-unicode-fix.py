...
expected_regex = r'`\\breturn\\s+(?:${dependent}\\s*==\\s*0|0\\s*==\\s*${dependent})\\s*;`'
if expected_regex not in text:
    raise SystemExit("generated JavaScript zero-check regex escaping is invalid")
